      ...
      <div className="border border-sirp-dashbordb1 rounded-[1.5rem] bg-sirp-secondary2  h-[12rem] mt-5  p-3">
        <div>
          <div className="flex flex-row items-center gap-3 pt-5">
            <div>
              <Image
                src={require('../../../../public/icons/frame05.svg')}
                alt="documents"
      ...
      <div className="border border-sirp-dashbordb1 rounded-[1.5rem] bg-sirp-secondary2  h-[12rem] mt-5  p-3">
        <div>
          <div className="flex flex-row items-center gap-3 pt-5">
            <div>
              <Image
                src={require('../../../../public/icons/frame06.svg')}
                alt="documents"
                className="cursor-pointer"
                width={75}
              />
      ...
      <div className="border border-sirp-dashbordb1 rounded-[1.5rem] bg-sirp-secondary2  h-[12rem] mt-5  p-3">
        <div>
          <div className="flex flex-row items-center gap-3 pt-5">
            <div>
              <Image
                src={require('../../../../public/icons/frame07.svg')}
                alt="documents"
                className="cursor-pointer"
                width={100}
              />
      ...
      <div className="border border-sirp-dashbordb1 rounded-[1.5rem] bg-sirp-secondary2  h-[12rem] mt-5  p-3">
        <div>
          <div className="flex flex-row items-center gap-3 pt-5">
            <div>
              <Image
                src={require('../../../../public/icons/frame08.svg')}
                alt="documents"
                className="cursor-pointer"
                width={100}
              />
      ...
      <div className="border border-sirp-dashbordb1 rounded-[1.5rem] bg-sirp-secondary2  h-[12rem] mt-5  p-3">
        <div>
          <div className="flex flex-row items-center gap-3 pt-5">
            <div>
              <Image
                src={require('../../../../public/icons/frame09.svg')}
                alt="documents"
                className="cursor-pointer"
                width={100}
              />
      ...
      <div className="border border-sirp-dashbordb1 rounded-[1.5rem] bg-sirp-secondary2  h-[12rem] mt-5  p-3">
        <div>
          <div className="flex flex-row items-center gap-3 pt-5">
            <div>
              <Image
                src={require('../../../../public/icons/frame0100.svg')}
                alt="documents"
                className="cursor-pointer"
                width={100}
              />
      ...
      <div className="border border-sirp-dashbordb1 rounded-[1.5rem] bg-sirp-secondary2  h-[12rem] mt-5  p-3">
        <div>
          <div className="flex flex-row items-center gap-3 pt-5">
            <div>
              <Image
                src={require('../../../../public/icons/frame011.svg')}
                alt="documents"
                className=" cursor-pointer"
                width={100}
              />
      ...
      <div className="border border-sirp-dashbordb1 rounded-[1.5rem] bg-sirp-secondary2  h-[12rem] mt-5  p-3">
        <div>
          <div className="flex flex-row items-center gap-3 pt-5">
            <div>
              <Image
                src={require('../../../../public/icons/frame012.svg')}
                alt="documents"
                className="cursor-pointer"
                width={100}
              />
      ...
      <div className="border border-sirp-dashbordb1 rounded-[1.5rem] bg-sirp-secondary2  h-[12rem] mt-5  p-3">
        <div>
          <div className="flex flex-row items-center gap-3 pt-5">
            <div>
              <Image
                src={require('../../../../public/icons/frame013.svg')}
                alt="documents"
                className="cursor-pointer"
                width={100}
              />
